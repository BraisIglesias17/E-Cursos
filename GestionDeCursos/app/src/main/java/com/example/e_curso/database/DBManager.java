...
public class DBManager extends SQLiteOpenHelper{
    ...
    public static final String USUARIO_COLUMN_ID="_id_USUARIO";
    ...
    public static final String CURSO_COLUMN_ID="_id_CURSO";
    ...
    //CONSTANTES PARA CURSOS_OFERTADOS

    public static final String USUARIO_PUBLICA_CURSO_TABLE_NAME="USUARIO_PUBLICA_CURSO";
    public static final String USUARIO_PUBLICA_CURSO_COLUMN_ID_USUARIO="_id_usuario";
    public static final String USUARIO_PUBLICA_CURSO_COLUMN_ID_CURSO="_id_curso";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        try {
            ...
            sqLiteDatabase.execSQL("CREATE TABLE IF NOT EXISTS " + USUARIO_ASISTE_CURSO_TABLE_NAME +"(" +
                    USUARIO_COLUMN_ID+" INTEGER," +
                    CURSO_COLUMN_ID + " INTEGER,"+
                    "foreign key ("+USUARIO_COLUMN_ID+" ) references "+USUARIO_TABLE_NAME+"("+USUARIO_COLUMN_ID+"),"+
                    "foreign key ("+CURSO_COLUMN_ID+" ) references "+CURSO_TABLE_NAME+"("+CURSO_COLUMN_ID+"),"+
                    "PRIMARY KEY("+USUARIO_COLUMN_ID+","+CURSO_COLUMN_ID+")"+
                    ")");
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        ...
        try {
            ...
            //ELIMINACION DE TABLA DE CURSOS PROPUESTOS
            sqLiteDatabase.execSQL("DROP TABLE IF EXISTS " +USUARIO_PUBLICA_CURSO_TABLE_NAME );
